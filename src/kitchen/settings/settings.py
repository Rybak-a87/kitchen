...
from kitchen.settings.env_identifier import *   # import (os, Path) here
...
SECRET_KEY = 'django-insecure-fr+ac_395^_=ix_ib_y155d00x46-z-uae(dj321&2in+9xm@8'
...
# STATIC_DIR = os.path.join(BASE_DIR, "kitchen", "static")
...
if DEBUG:
    from kitchen.settings.settings_local import *